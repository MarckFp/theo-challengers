...
export async function brutalCleanup(page) {
  try {
    await page.evaluate(() => {
      ...
      // Remove modal backdrops (these are often separate divs in daisyUI)
...
export async function clickTab(page, index) {
...
export async function seedCoins(page, amount) {
...
export async function seedInventory(page, itemData = {}) {
