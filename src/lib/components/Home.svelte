<script lang="ts">
    ...
    const icons = {
        ...
        leaderboard: `<path stroke-linecap="round" stroke-linejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 0 1 3 3h-15a3 3 0 0 1 3-3m9 0v-3.375c0-.621-.504-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0V9.499a1.125 1.125 0 0 0-1.125-1.125h-1.5v2.161c0 .621-.504 1.125-1.125 1.125H8.625" />`,
